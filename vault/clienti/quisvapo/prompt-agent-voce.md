...
provider `scribe_realtime`, LLM `gemini-2.0-flash` (veloce ma accurato, scelto da Marco; Sonnet 5 provato ma troppo lento — se serve reattivita' pura, gemini-2.0-flash o LLM Groq custom). Il
